...
public class CoverFoxResultPage {
	...
	{
		String ar[]=resultText.getText().split(" ");
		Reporter.log("getting getPlanNumersFromString", true);
		int result = Integer.parseInt(ar[0]);
		return result;
	}
	...
	public int getPlanNumersFromBanners()
	{
		...
		Reporter.log("getting getPlanNumersFromBanners", true);
	...
	{
		Reporter.log("cehcking if sortPlanFilterIsDisplayed ", true);
